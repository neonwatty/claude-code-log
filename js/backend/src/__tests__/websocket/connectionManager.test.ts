...
describe('ConnectionManager', () => {
  ...
  describe('Client Management', () => {
    it('should add a client and return client ID', () => {
      ...
      const clientId = connectionManager.addClient(mockWebSocket as any, metadata);
  ...
  describe('Message Broadcasting', () => {
    it('should broadcast message to all clients', () => {
      ...
      const message: ISessionCreatedMessage = {
        ...
        data: { sessionId: 'test-123', cwd: '/test', timestamp: new Date().toISOString() }
      };
    ...
    it('should handle broadcast to closed connections', () => {
      ...
      const message: ISessionUpdatedMessage = {
        ...
        timestamp: new Date().toISOString(),
        data: { sessionId: 'test-456', cwd: '/test', entryCount: 1, lastActivity: new Date().toISOString() }
      };
