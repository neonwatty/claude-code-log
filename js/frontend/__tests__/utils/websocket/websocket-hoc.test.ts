...
describe("withWebSocket HOC", () => {
  ...
  describe("HOC Factory", () => {
    ...
    it("should add WebSocket controller to the component", () => {
      ...
      expect(typeof instance.webSocketController.updateProperty).toBe(
        "function",
      );
    });
  ...
  describe("Configuration Inheritance", () => {
    it("should accept different configurations for different components", () => {
      ...
      expect((instance1 as any).webSocketController.config).toEqual(
        expect.objectContaining(Config1),
      );
      expect((instance2 as any).webSocketController.config).toEqual(
    ...
    it("should use default configuration when none provided", () => {
      ...
      expect(typeof (instance as any).webSocketController.config).toBe(
        "object",
      );
    });
  });
