...
describe('Connection State Management', () => {
  ...
  describe('getStateChangeAnnouncement', () => {
    it('should create appropriate announcement for connection', () => {
      ...
      expect(announcement).toContain('WebSocket connection state changed to Connected');
    ...
    it('should create appropriate announcement for disconnection', () => {
      ...
      expect(announcement).toContain('WebSocket connection state changed to Disconnected');
    ...
    it('should create appropriate announcement for reconnecting', () => {
      ...
      expect(announcement).toContain('WebSocket connection state changed to Reconnecting');
    ...
    it('should create appropriate announcement for error', () => {
      ...
      expect(announcement).toContain('WebSocket connection state changed to Error');
    ...
    it('should handle connecting state', () => {
      ...
      expect(announcement).toContain('WebSocket connection state changed to Connecting');
