...
export class SessionListItemWorking extends LitElement {
  static styles = [
    baseStyles,
    css`
      :host {
...
export class SessionListWorking extends LitElement {
  static styles = [
    baseStyles,
    css`
      :host {
  ...
  private renderSessionsList(sessions) {
  ...
  private handleSearchInput = this.debounce((event) => {
...
declare global {
  interface HTMLElementTagNameMap {
    'session-list-working': SessionListWorking;
    'session-list-item-working': SessionListItemWorking;
  }
}