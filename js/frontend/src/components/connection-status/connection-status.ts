...
export class ConnectionStatusComponent extends BaseComponent {
  ...
  static override styles: CSSResult[] = [
    ...
    css`
      ...
      .quality-excellent { background: var(--color-success); }
      .quality-good { background: #4CAF50; }
      .quality-fair { background: var(--color-warning); }
      .quality-poor { background: var(--color-error); }
      .quality-unknown { background: var(--color-text-muted); }
  ...
  private startAnimationLoop() {
    this.animationInterval = window.setInterval(() => {
      const shouldAnimate = this.connectionState === ConnectionState.CONNECTING || 
  ...
  override render() {
    ...
    return html`
      ...
      >
        <span class="status-icon ${this.animateIcon ? 'animated' : ''}" role="img" aria-hidden="true">
          ${stateDisplay.icon}
        </span>
        ...
        <div class="quality-indicator quality-${quality}" 
             title="Connection quality: ${quality}"></div>
        ...
        <div class="debug-section">
          ...
          <div class="debug-grid">
            ...
            <div class="debug-item">
              ...
              <span class="debug-value">${this.getReadyStateText(this.debugInfo.readyState)}</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Protocol:</span>
              <span class="debug-value">${this.debugInfo.protocol || 'None'}</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Extensions:</span>
              <span class="debug-value">${this.debugInfo.extensions || 'None'}</span>
            </div>
          </div>
        </div>
        ...
        <div class="debug-section">
          ...
          <div class="debug-grid">
            <div class="debug-item">
              ...
              <span class="debug-value">${formatUptime(this.debugInfo.statistics.uptime)}</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Reconnections:</span>
              <span class="debug-value">${this.debugInfo.statistics.reconnectionCount}</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Avg Latency:</span>
              <span class="debug-value">${this.debugInfo.statistics.averageLatency}ms</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Quality:</span>
              <span class="debug-value">${this.debugInfo.statistics.connectionQuality}</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Messages Sent:</span>
              <span class="debug-value">${this.debugInfo.statistics.messagesSent}</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Messages Received:</span>
              <span class="debug-value">${this.debugInfo.statistics.messagesReceived}</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Data Sent:</span>
              <span class="debug-value">${formatDataSize(this.debugInfo.statistics.totalDataSent)}</span>
            </div>
            <div class="debug-item">
              <span class="debug-label">Data Received:</span>
              <span class="debug-value">${formatDataSize(this.debugInfo.statistics.totalDataReceived)}</span>
            </div>
          </div>
        </div>
        ...
        <div class="debug-section">
          ...
          <div class="debug-grid">
            <div class="debug-item">
              ...
              <span class="debug-value">
                ${this.debugInfo.lastHeartbeat 
                  ? this.formatRelativeTime(new Date(this.debugInfo.lastHeartbeat))
                  : 'Never'
                }
              </span>
            </div>
            ...
            <div class="debug-item">
              ...
              <span class="debug-value">${formatDataSize(this.debugInfo.bufferedAmount)}</span>
            </div>
            <div class="debug-item">
