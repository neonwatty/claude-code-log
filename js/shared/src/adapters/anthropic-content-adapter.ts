...
export function convertContentToAnthropic(
  ...
  return content
    .map(convertContentItemToAnthropic)
 ...
 */
export function convertContentToAnthropicParam(
  content: IContentItem[],
): AnthropicContentBlockParam[] {
  return content
    .map(convertContentItemToAnthropicParam)
    .filter(Boolean) as AnthropicContentBlockParam[];
}

/**
 * Converts Anthropic content blocks to internal content format
 */
export function convertContentFromAnthropic(
 ...
 */
export function convertContentFromAnthropicParam(
 ...
 */
export function convertContentItemToAnthropic(
  item: IContentItem,
 ...
 */
export function convertContentItemToAnthropicParam(
  item: IContentItem,
 ...
 */
export function convertAnthropicContentToInternal(
  ...
  switch (block.type) {
    ...
    default:
      throw new Error(
        `Unsupported Anthropic content block type: ${(block as any).type}`,
      );
  }
}
 ...
 */
export function convertAnthropicContentParamToInternal(
  param: AnthropicContentBlockParam,
): IContentItem {
  switch (param.type) {
    case "text":
      return {
    ...
    default:
      throw new Error(
        `Unsupported Anthropic content param type: ${(param as any).type}`,
      );
  }
}
