 ...
 */
export function convertToolUseToAnthropic(
  toolUse: IToolUseContent,
): AnthropicToolUseBlock {
  return {
    type: "tool_use",
    id: toolUse.id,
 ...
 */
export function convertToolUseToAnthropicParam(
  toolUse: IToolUseContent,
): AnthropicToolUseBlockParam {
  return {
    type: "tool_use",
 ...
 */
export function convertToolResultToAnthropicParam(
  toolResult: IToolResultContent,
): AnthropicToolResultBlockParam {
  return {
    type: "tool_result",
 ...
 */
export function convertAnthropicToolUseToInternal(
 ...
 */
export function convertAnthropicToolResultToInternal(
 ...
 */
export function createSpecificToolChoice(
  toolName: string,
): AnthropicToolChoiceTool {
  return {
    type: "tool",
 ...
 */
export function isAutoToolChoice(
  choice: AnthropicToolChoice,
): choice is AnthropicToolChoiceAuto {
  return choice.type === "auto";
}

export function isAnyToolChoice(
  choice: AnthropicToolChoice,
): choice is AnthropicToolChoiceAny {
  return choice.type === "any";
}

export function isNoneToolChoice(
  choice: AnthropicToolChoice,
): choice is AnthropicToolChoiceNone {
  return choice.type === "none";
}

export function isSpecificToolChoice(
  choice: AnthropicToolChoice,
): choice is AnthropicToolChoiceTool {
...
export function isAnthropicToolResult(
  param: any,
): param is AnthropicToolResultBlockParam {
  return (
    param &&
 ...
 */
export function createBasicToolSchema(
  parameters: string[],
): Record<string, any> {
