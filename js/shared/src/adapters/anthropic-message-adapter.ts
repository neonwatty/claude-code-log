...
import { IUserMessage, IAssistantMessage, IUsageInfo } from "../interfaces";
import {
  AnthropicMessage,
 ...
 */
export function convertUserMessageToAnthropic(
 ...
 */
export function convertAnthropicMessageParamToInternal(
  param: AnthropicMessageParam,
): IUserMessage {
  return {
    role: "user",
    content:
 ...
 */
export function convertAnthropicMessageToInternal(
 ...
 */
export function convertUsageToAnthropic(
  usage?: IUsageInfo,
 ...
 */
export function convertUsageFromAnthropic(
  usage?: AnthropicUsage,
): IUsageInfo | undefined {
  if (!usage) return undefined;
 ...
 */
export function isAnthropicMessageParam(
  param: any,
): param is AnthropicMessageParam {
  return (
    param !== null &&
    param !== undefined &&
    typeof param === "object" &&
 ...
 */
export function convertAnthropicCreateParamsToInternal(
  params: AnthropicMessageCreateParams,
) {
  return {
    model: params.model,
    messages: params.messages.map((msg) =>
      convertAnthropicMessageParamToInternal(msg),
    ),
