...
- button "Connect"
- button "Reconnect"
- text: "Application Statistics 8/27/2025, 3:42:33 PM 1 Users 1 Log Entries ☀️ Theme 0 Messages Sent 0 Messages Received 1 Reconnections Welcome to Claude Code Log - Real-time session visualization and analysis Connection Status: RECONNECTING | Quality: unknown"
...
- alert "Connection Reconnecting":
  ...
  - paragraph: WebSocket connection state changed to Reconnecting. Attempting to restore connection.
  - button "Close notification": ✕
- text: "Connection Reconnecting. WebSocket connection state changed to Reconnecting. Attempting to restore connection. 🐛 DEBUG MODE - Test Paused 🐛 DEBUG MODE - Test Paused 🐛 DEBUG MODE - Test Paused Connection status: RECONNECTING 🐛 DEBUG MODE - Test Paused 🐛 DEBUG MODE - Test Paused"
```