...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "../../../../shared/src/schemas/index.js": resolve(
        __dirname,
      ...
      "../../src/components/(.*).js$": resolve(
        __dirname,
        "./frontend/src/components/$1.ts",
      ),
      "../base/(.*).js$": resolve(
        __dirname,
        "./frontend/src/components/base/$1.ts",
      ),

      // WebSocket service mappings
      "../../services/(.*).js$": resolve(
        __dirname,
        "./frontend/src/services/$1.ts",
      ),

      // WebSocket utility mappings with mocks
      "./message-handlers.js": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/message-handlers-mock.js",
      ),
      "./message-types.js": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/message-types-mock.js",
      ),
      "./connection-state.js": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/connection-state-mock.js",
      ),

      // Integration test WebSocket mappings
      "../../src/utils/websocket/websocket-controller": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/websocket-controller-mock.js",
      ),
      "../../src/utils/websocket/message-handlers": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/message-handlers-mock.js",
      ),
      "../../src/utils/websocket/message-types": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/message-types-mock.js",
      ),
      "../../src/utils/websocket/connection-state": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/connection-state-mock.js",
      ),

      // Mock library mappings
      "@open-wc/testing": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/@open-wc-testing-mock.js",
      ),
      lit$: resolve(__dirname, "./frontend/__tests__/__mocks__/lit-mock.js"),
      "lit/decorators.js": resolve(
        __dirname,
        "./frontend/__tests__/__mocks__/lit-decorators-mock.js",
      ),
    },
  },
});
